...
import { User, Mail, Lock, Eye, EyeOff, ShieldAlert, LifeBuoy, ShieldCheck } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center justify-center font-sans p-4">
            <div className="mb-8 text-center">
                ...
                <h1 className="text-3xl font-bold text-white tracking-tight">Get Started With Us </h1>
                <p className="text-gray-400 text-sm mt-1">Enter your credentials to Be an Admin</p>
            </div>
